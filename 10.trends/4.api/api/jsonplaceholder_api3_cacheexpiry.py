...
class JSONPlaceholderAPI:
    def __init__(self):
        ...
        self.cache = {}
        self.cache_expiry_time = 10  # 캐시 만료 시간 (초 단위)
    ...
    def _is_cache_expired(self, cache_entry):
        return (time.time() - cache_entry['timestamp']) > self.cache_expiry_time
    ...
    def view_cache(self):
        ...
        for key, value in self.cache.items():
            print(f"Key: {key}, Value: {value['data']}, Timestamp: {value['timestamp']}")
        print("--- Cache End ---\n")
