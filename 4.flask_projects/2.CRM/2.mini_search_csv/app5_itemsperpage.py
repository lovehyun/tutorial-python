...
def index():
    ...
    items_per_page = request.args.get('items_per_page', default=10, type=int)  # 한 페이지에 보여줄 항목 수
    ...
    return render_template('index5.html', **context) # unpacking
    # return render_template('index5.html', fieldnames=headers, data=paginated_data, search_name=search_name, page=page, total_pages=total_pages, items_per_page=items_per_page)
